...
class UserService:
    async def create_user(self, user_data, db: AsyncSession = None) -> Dict[str, Any]:
        """Create a new user"""
    ...
    async def get_user_by_id(self, user_id: int, db: AsyncSession = None) -> Optional[Dict[str, Any]]:
        """Get user by ID"""
    ...
    async def get_user_by_email(self, email: str, db: AsyncSession = None) -> Optional[Dict[str, Any]]:
        """Get user by email"""
        async def _get_user(session: AsyncSession):
            result = await session.execute(
    ...
    async def update_user(self, user_id: int, user_data, db: AsyncSession = None) -> Optional[Dict[str, Any]]:
    ...
    async def delete_user(self, user_id: int, db: AsyncSession = None) -> bool:
        """Delete user"""
    ...
    async def list_users(
        ...
        async def _list_users(session: AsyncSession):
            query = select(User)
